...
Read [the Ladybird documentation](https://github.com/LadybirdBrowser/ladybird/tree/master/Documentation) if you'd like
to understand how Ladybird works.
...
We encourage everyone to share their personal views and opinions outside project spaces, so we can keep them focused on
project goals.
